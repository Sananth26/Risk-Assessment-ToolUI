                    ...
                    if (fieldData.subtype) {
                        if (fieldData.subtype === 'quill') {
                            ...
                            if ((<any>window).fbEditors.quill[id]) {
                                let instance = (<any>window).fbEditors.quill[id].instance;
                            ...
                            if ((<any>window).tinymce.editors[id]) {
                                let editor = (<any>window).tinymce.editors[id];
   ...
   async save(stage = null) {
    ...
    stickyControls() {
        ...
        $(window).scroll(function (evt) {
            ...
            let offset = (<any>Object).assign(
                {},
                offsetDefaults,
                (<any>config).opts.stickyControls.offset
            );
