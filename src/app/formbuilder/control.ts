...
import mi18n from '../formbuilder/mi18n';
...
export class control {
    ...
    public id: any;
    public type: any;
    public static controlConfig : any;
    public static classRegister: any = {};
    public element: any;
    ...
    constructor(config, preview) {
        ...
        const properties = ['label', 'description', 'subtype', 'required'];
  ...
  /**
     ...
     */
    static getRegistered(type = false): Array<any> {
        let types = (<any>Object).keys(control.classRegister);
        if (!types.length) {
            return types;
        }
     ...
     */
    static getClass(type: any, subtype = null): any {
     ...
     */
    static loadCustom(controls: any = null): void {
        let controlClasses = [];
        if (controls) {
        ...
        if ((<any>window).fbControls) {
            controlClasses = controlClasses.concat((<any>window).fbControls);
        }
     ...
     */
    static mi18n(lookup : any, args : any = null) {
