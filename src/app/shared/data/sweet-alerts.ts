...
export function typeSaveFailure() {
    swal("Error!","Your Data has not been saved.'error'!",  "error");
}
//cancel
export function typeCancel() {
    swal("Warning!!"," Operation is being Cancelled", "error");
}

// Sign Up Success Alert
export function typeSignUpSuccess() {
    swal("Registered!", "User Registration Successful", "success");
}
export function typeSignUpError() {
    swal("Error!","Registration Unsuccessful!","error");
}
//for user name exists
export function typeSignUpUserError() {
    swal("Error!","Registration Unsuccessful! User Name Exists","error");
}
//for mobile number exists
export function typeSignUpMobileNoError() {
    swal("Error!","Registration Unsuccessful! Mobile Number already in use!","error");
}
//for email Id exists
export function typeSignUpEmailIdError() {
    swal("Error!","Registration Unsuccessful! Email Address already in use!","error");
}
//signin error
export function typeSignInError() {
    swal("Error!","Login Failed! Username or password you entered is incorrect","error");
}
